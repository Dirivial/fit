...
const SetList = ({
  ...
  return (
    <section className="flex flex-col sm:flex-row justify-start rounded shadow-xl">
      ...
      <div ref={child} className="flex flex-col sm:flex-row overflow-x-scroll">
        {sets.map((set, index) => {
          return (
            <div
              key={index}
      ...
      <div className="flex sm:flex-col justify-center sm:pb-0 pb-2">
        <div className="p-1" />
        <button
          onClick={() => {
